...
(2, 'HTC U11', '隆重推出 Edge Sense 側框感應，開啟手機互動操作的新紀元。 \n\nHTC 以創新為本，就跟所有使用者一樣，我們總是不斷嘗試、不停追尋、持續精進。為了超越觸控式螢幕，我們開發出一種全新直覺化的手機互動操作 – Edge Sense側框感應。透過輕鬆的握壓方式，為使用者帶來全新體驗。 \n\n但我們並不以此為傲，HTC U11採用令人驚嘆的3D水漾玻璃表面，不僅有型好握好看並加入防塵防水，全新 HTC UltraPixel 3 (1200萬)主相機，獲得DxOMarki史上智慧型手機相機最高的評分，Usonic個人化音效加入主動降噪功能讓音質更純淨，並且搭載旗艦級最快速CPU，最大容量與雙卡雙待，使用者從此將對智慧型手機有更高的預期標準。', 5.32, 'produitImages/phone02.jpg', 10, '2014-12-27 12:06:58'),
