		...
		<div id="content-table-inner">
			...
			<div id="table-content">
				...
				<tr>
					...
					<th class="table-header-repeat line-left"><a >留言訊息ID</a></th>
					<th style="width: 120px" class="table-header-repeat line-left"><a >訪客名稱</a></th>
					<th style="width: 120px"  class="table-header-repeat line-left"><a >訪客email</a></th>
					<th style="width: 120px"  class="table-header-repeat line-left"><a >留言訊息內容</a></th>
...
//                                            etat="Actif";
				 	...
				 	<td><input type="checkbox"/></td>
                                        ...
                                        <td><%= list.get(i).getMsgGuestId() %></td>
                                        <td><%= list.get(i).getMsgGuestName() %></td>
                                        <td><%= list.get(i).getGuestGuestEmail() %></td>
